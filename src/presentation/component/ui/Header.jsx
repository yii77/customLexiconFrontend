...
import { compositeLayout, iconStyles } from '../../style';
...
export function CommonHeader({
    ...
    if (leftImageSource) {
      return (
        <ImageButton
          ...
          onPress={onLeftPress}
          buttonStyle={[style.commonHeaderLeftBtn, leftBtnStyle]}
          imageStyle={[iconStyles.lg, leftImageStyle]}
    ...
    if (leftText) {
      return (
        <TextButton
          ...
          onPress={onLeftPress}
          buttonStyle={[style.commonHeaderLeftBtn, leftBtnStyle]}
          textStyle={[style.commonHeaderBtnText, leftTextStyle]}
          activeButtonStyle={activeLeftBtnStyle}
    ...
    if (rightImageSource) {
      return (
        <ImageButton
          ...
          buttonStyle={[style.commonHeaderRightBtn, rightBtnStyle]}
          imageStyle={[iconStyles.lg, rightImageStyle]}
    ...
    if (rightText) {
      return (
        <TextButton
          ...
          onPress={onRightPress}
          buttonStyle={[style.commonHeaderRightBtn, rightBtnStyle]}
          textStyle={[style.commonHeaderBtnText, rightTextStyle]}
          activeButtonStyle={activeRightBtnStyle}
  ...
  return (
    <View style={[compositeLayout.rowCenterCenter, headerStyle]}>
      {renderLeft()}
      <Text style={[style.commonHeaderTitle, titleStyle]}>{title}</Text>
      {renderRight()}
    </View>
  );
}
